-- Script SEGURO para agregar las entradas en Operations_Types para el menú y operaciones masivas
-- Este script debe ejecutarse DESPUÉS de add-products-services-operation-types-safe.sql
-- IMPORTANTE: Verificar el último id_operation_type antes de ejecutar

-- Verificar qué IDs ya existen
-- SELECT id_operation_type, description FROM Operations_Types WHERE id_operation_type BETWEEN 26 AND 27;
